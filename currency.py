...
loader = Image.open("79b3c5f0-lotto-results.jpg.optimal.jpg")
...
text = Text(window, height=8, width=40, font=('sans serif', '10', 'bold'), bg="gold")
text.place(x=150, y=120)
# Buttons
B = Button(window, text="Convert", command=show_data, font=('sans serif', '10', 'bold'),
           borderwidth=3, bg="green", fg="white")
B.place(x=10, y=130)
